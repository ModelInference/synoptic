...
/**
 * To test that EventType encodings of 2 equal sets of events are equal,
 * and that of 2 different sets of events are not equal.
 */
public class EventTypeEncodingsTests extends DynopticTest {
    ...
    /** Converts a list of DistEventType instances into a set, and returns the set. */
    ...
    private void checkEncodingEquality(Set<DistEventType> eventSet1,
        ...
        EventTypeEncodings<DistEventType> encoding1 = 
                new EventTypeEncodings<DistEventType>(eventSet1);
        EventTypeEncodings<DistEventType> encoding2 = 
                new EventTypeEncodings<DistEventType>(eventSet2);
