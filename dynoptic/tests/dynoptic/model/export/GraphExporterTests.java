...
public class GraphExporterTests extends DynopticTest {
	...
	private static final String DOT_OUTPUT = "./test.dot";
	...
	private void generateOutput(CFSM cfsm) throws IOException {
		GraphExporter.exportCFSM(DOT_OUTPUT, cfsm, true);
		GraphExporter.generatePngFileFromDotFile(DOT_OUTPUT);
	}
}
