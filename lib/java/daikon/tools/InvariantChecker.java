...
public class InvariantChecker {
  ...
  private static void checkInvariants(File inv_file) throws IOException {
    ...
    checkInvariants(inv_file.toString(), ppts);
  }

public static void checkInvariants(String inv_file, PptMap ppts)
		throws IOException {
	filterInvariants(ppts);
...
private static void filterInvariants(PptMap ppts) {
