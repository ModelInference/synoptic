...
@SuppressWarnings("nullness") // ***** TEMPORARY:  def_points is confused, needs review/refactoring/rewriting
  ...
  implements Serializable, Cloneable
{
 ...
 double maxsep_triples (Point[] pa) {
   ...
   Point p1 = pa[0], p2 = pa[0], p3 = pa[0]; // initalize so never null
   // max_separation is the separation metric for the most separated
