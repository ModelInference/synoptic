...
public class DaikonTrace {
	...
	public boolean addInstance(List<Object> enter_values, List<Object> exit_values) {
	...
	private String ProgramPointInstanceToString(List o1, String ProgramPointInstanceType) {
