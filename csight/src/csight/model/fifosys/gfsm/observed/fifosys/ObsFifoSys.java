package csight.model.fifosys.gfsm.observed.fifosys;
...
import csight.invariants.checkers.BinChecker;
import csight.invariants.checkers.BinChecker.Validity;
import csight.model.fifosys.FifoSys;
import csight.model.fifosys.gfsm.observed.ObsFSMState;
import csight.model.fifosys.gfsm.observed.dag.ObsDAG;
...
public class ObsFifoSys extends FifoSys<ObsFifoSysState, DistEventType> {
    ...
    public static List<ObsFifoSys> synTraceGraphToDynObsFifoSys(
        ...
        // Build a CSight ObsDAG for each Synoptic trace DAG.
        for (int traceId = 0; traceId < traceGraph.getNumTraces(); traceId++) {
            ...
            // create the corresponding CSight states (without remote
            // dependencies).
     ...
     * corresponding CSight states (without remote dependencies).
     * 
     * @param numProcesses
     * @param consistentInitState
     * @param preEventNodesMap
