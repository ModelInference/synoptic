...
public class InvModel extends EncodedAutomaton {
	...
	/**
	 * Generates an EncodedAutomaton for the given invariant. Encodes the names of both
	 * EventTypes composing the invariant and constructs the Automaton by using those characters
	 * in a regex representing the invariant.
	 */
