 ...
 * state being inhabited.  This allows for synoptic.model checking which yields
 * short counterexample paths for failing synoptic.invariants.
 * 
...
public abstract class TracingStateSet<T> implements IStateSet<T, TracingStateSet<T>> {	
	 ...
	 * synoptic.model graph.  This linked list structure is used, rather than explicit
