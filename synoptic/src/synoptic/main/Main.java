...
public class Main implements Callable<Integer> {
     ...
     */
    public static String findSyntheticTraces(PartitionGraph pGraph) {
    ...
    /**
     * Helper method for {@code findSyntheticTraces}. Recursively finds all
     * possible paths from the partition graph and adds them to a set. TODO:
     * This will calculate any subset of nodes multiple times if the topmost
     ...
     *            The current node
     * @param pGraph
     *            The graph of partitions (for extracting adjacences from the
     *            node).
     * @param allPaths
     ...
     */
    private static void findAllPaths(Partition node, PartitionGraph pGraph,
            HashSet<String> allPaths, ArrayList<Partition> prefixPath) {
