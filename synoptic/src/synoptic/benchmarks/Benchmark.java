 ...
 * ConfigureableBenchmark, and pass it to the constructor. The synoptic.benchmarks can be
...
public class Benchmark<ArgumentType> {
	 ...
	 * @param taskFactory
	 *            the taskFactory that creates synoptic.benchmarks from configuration
	 *            arguments
	 */
