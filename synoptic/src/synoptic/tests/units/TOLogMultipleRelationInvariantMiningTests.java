...
public class TOLogMultipleRelationInvariantMiningTests extends SynopticTest {
	...
	public final String[] relationSubgraphIsolatedFromInitial = {"1 w", "2 r x"};
	...
	public void relationSubgraphIsolatedFromInitial() throws Exception {
		...
		trueInvs.add(new AlwaysFollowedInvariant(
        		...
        		defRelation));
		trueInvs.add(new AlwaysFollowedInvariant(
        		StringEventType.newInitialStringEventType(), "x", 
        		defRelation));
	...
	public void relationSubgraphIsolatedFromSpecialNodes() throws Exception {
		...
		trueInvs.add(new AlwaysFollowedInvariant(
        		...
        		defRelation));
		trueInvs.add(new AlwaysFollowedInvariant(
        		StringEventType.newInitialStringEventType(), "y", 
        		defRelation));
		trueInvs.add(new AlwaysFollowedInvariant("w", "x",
        		defRelation));
	...
	public void multipleIsolatedRelationSubgraphs() throws Exception {
		...
		trueInvs.add(new AlwaysFollowedInvariant(
        		StringEventType.newInitialStringEventType(), "v", 
        		defRelation));
		trueInvs.add(new AlwaysFollowedInvariant(
        		StringEventType.newInitialStringEventType(), "w", 
        		defRelation));
		...
		trueInvs.add(new AlwaysFollowedInvariant(
        		...
        		defRelation));
		trueInvs.add(new AlwaysFollowedInvariant(
        		StringEventType.newInitialStringEventType(), "z", 
        		defRelation));
