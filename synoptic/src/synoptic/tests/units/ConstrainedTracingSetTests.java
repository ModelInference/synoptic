...
public class ConstrainedTracingSetTests extends PynopticTest {
    ...
    /**
     * Common code for testing failure states of tracing sets for upper-bound
     * constrained invariants
     */
    private void UpperFailureStateTestCommon(String[] events, String invString,
    ...
    public void APUpperFailureStateTest() throws Exception {
        UpperFailureStateTestCommon(eventsAP, "x AP z upper",
                TracingSet.APUpper);
    }
    ...
    public void AFbyUpperFailureStateTest() throws Exception {
        UpperFailureStateTestCommon(eventsAFby, "x AFby z upper",
     ...
     */
    private void UpperCounterExamplePathTestCommon(String[] events,
            String invString, TracingSet type) throws Exception {
    ...
    public void APUpperCounterExamplePathTest() throws Exception {
        UpperCounterExamplePathTestCommon(eventsAP, "x AP z upper",
                TracingSet.APUpper);
    }
    ...
    public void AFbyUpperCounterExamplePathTest() throws Exception {
        UpperCounterExamplePathTestCommon(eventsAFby, "x AFby z upper",
                TracingSet.AFbyUpper);
    }
}
