...
public class Trace {
	...
	public void addRelationPath(String relation, EventNode eNode) {
		paths.put(relation, new RelationPath(eNode, relation, Event.defaultTimeRelationString));
	}
	...
	public Map<EventType, Map<EventType, Integer>> getFollowedByCounts(String relation) {
		if (!paths.containsKey(relation)) {
			throw new IllegalArgumentException("Trace doesn't contain the " +
					relation + " relation");
		}
	...
	// TODO: Make the return type deeply unmodifiable
    public Map<EventType, Map<EventType, Integer>> getPrecedesCounts(String relation) {
		if (!paths.containsKey(relation)) {
			throw new IllegalArgumentException("Trace doesn't contain the " +
					relation + " relation");
		}
