...
public class NfsTraceParser extends DefaultScalableTraceParser {
    ...
    private Action parseTraceEntry(String entry) {
        /*
         * COMMON FOR REQUEST/RESPONSE 1. Time (seconds.microseconds) when the
         * packet was seen. Due to a misconfiguration of the clock on the EECS
         * lair62 monitor, sometimes time will suddenly jump backwards for five
         * minutes for a few moments. This seems to happen about once a week.
         * Unfortunately I didn't notice this in time to do anything about it.
         * 2. Source address (iaddr.port) 3. Destination address (iaddr.port) 4.
         * Transport protocol (U=udp, T=tcp). From the original traces
         ...
         * nfs v3 response, C2 = nfs v2 call, R2 = nfs v2 call). 6. RPC XID
         * field. 7. RPC function (numeric value). This is redundant with field
         * 8. 8. RPC function (canonical name). For example, getattr, lookup,
         * read, write, ...
         */
