...
public class PartitionGraph implements IGraph<Partition> {
     ...
     */
    private final LinkedHashMap<String, Set<MessageEvent>> initialMessages = new LinkedHashMap<String, Set<MessageEvent>>();
    ...
    private void addInitialMessages(Set<MessageEvent> initialMessages,
        ...
        if (!this.initialMessages.containsKey(relation)) {
            this.initialMessages.put(relation,
    ...
    /**
     * An anonymous class instance implementing ModifiableGraph<Partition>,
     * which can be passed to methods that must modify this PartitionGraph
     * instance.
     */
    private final IModifiableGraph<Partition> modifiableInterface = new IModifiableGraph<Partition>() {
