...
public class NFbyInvFsms<T extends INode<T>> extends FsmStateSet<T> {
	public NFbyInvFsms(int size)                   { super(size, 3); }
	public NFbyInvFsms(List<BinaryInvariant> invs) { super(invs, 3); }

	@Override
	public boolean isFail() { return !sets.get(2).isEmpty(); }
	@Override
	public BitSet whichFail() { return (BitSet)sets.get(2).clone(); }
	@Override
	public BitSet whichPermanentFail() { return (BitSet)sets.get(2).clone(); }
	...
	public void transition(T input) {
		...
		/* NOTE: unlike the other synoptic.invariants, isA and isB can be simultaneously 1
		 * 
