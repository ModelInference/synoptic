...
/**
 * Tests for main.ListedProperties class
 * 
 * @author ivan
 */
public class ListedPropertiesTest {
	...
	public void onePropMultValsTest() {
		String[] cmdArgs = optionsStringToCmdArgs("-option some-value\n-option some-value2");
		assertArrayEquals(cmdArgs, new String[] {"-option","some-value", "-option", "some-value2"});
	}
	...
	public void multPropsMultValsTest() {
		String[] cmdArgs = optionsStringToCmdArgs(
				"-opt1 val1\n-opt1 val2\n-opt2 val3\n-opt2 val4");
		...
		String[] order1 = {"-opt1","val1","-opt1","val2","-opt2", "val3", "-opt2", "val4"};
		String[] order2 = {"-opt2", "val3", "-opt2", "val4","-opt1","val1","-opt1","val2"};
		assertTrue(Arrays.equals(order1, cmdArgs) || Arrays.equals(order2, cmdArgs));
	}
}
