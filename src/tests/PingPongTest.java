...
/**
 * Main Class. To create you own examples construct a transition system, 
 * as done in pingExample.
 * 
 * The program will export the graphs before and after minimization.
 * 
 * @author sigurd
 */
...
public class PingPongTest {
	static public void main(String[] args) throws Exception {
		...
		PartitionGraph g = Bisimulation.getRefinedSystem(t);
