...
public class SplitTest {
	...
	public void test() throws Exception {
		...
		Action t = new Action("t");
		MessageEvent a1 = new MessageEvent(a, null, null, 1);
		MessageEvent a2 = new MessageEvent(a, null, null, 1);
		MessageEvent a3 = new MessageEvent(a, null, null, 1);
		MessageEvent a4 = new MessageEvent(a, null, null, 1);
		MessageEvent A1 = new MessageEvent(A, null, null, 1);
		MessageEvent B1 = new MessageEvent(B, null, null, 1);
