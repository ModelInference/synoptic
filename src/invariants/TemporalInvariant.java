...
public interface TemporalInvariant {
	 ...
	 * @param path the couter-example path
	 * @return a prefix of {@code path} that still violates the the property 
	 */
	public <T extends INode<T>> List<T> shorten(List<T> path);
	
	/**
	 * get the Büchi-automaton that corresponds to this LTL property. This method should cache the automaton.
	...
	/**
	 * Get the set of predicates occurring in this property. Predicates are here labels of states.
