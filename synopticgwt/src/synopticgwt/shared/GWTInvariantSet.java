...
public class GWTInvariantSet implements Serializable {
     ...
     */
    public HashMap<String, List<GWTInvariant<String, String>>> invs;

    public GWTInvariantSet() {
        invs = new HashMap<String, List<GWTInvariant<String, String>>>();
    }
    ...
    private void addInvType(String invType) {
        if (invs.containsKey(invType)) {
            ...
            invs.put(invType, new LinkedList<GWTInvariant<String, String>>());
        }
    }
     ...
     *            a pair of strings
     */
    public void addInv(String invType, GWTInvariant<String, String> invPair) {
        addInvType(invType);
     ...
     * @return
     */
    public List<GWTInvariant<String, String>> getInvs(String invType) {
