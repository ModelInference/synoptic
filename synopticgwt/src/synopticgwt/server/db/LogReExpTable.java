...
/**
 * LogReExp table. Schema: parseid, reid, logid
 */
public class LogReExpTable extends DerbyTable {

    public LogReExpTable(Connection conn) {
        super(conn, "CREATE TABLE LogReExp (parseid INT, reid INT, logid INT)");
    }
    ...
    /**
     * Returns ResultSet of "SELECT * from LogReExp" query. Note: must call
